...
import com.thanhkhiem.socialinstaapp.AddStoryActivity;
...
import com.thanhkhiem.socialinstaapp.StoryActivity;
...
public class StoryAdapter extends RecyclerView.Adapter<StoryAdapter.ViewHolder>{
    ...
    private void userInfo(final ViewHolder viewHolder, String userid, final int pos){
        DatabaseReference reference = FirebaseDatabase.getInstance(StartActivity.DTALINK).getReference("Users").child(userid);
